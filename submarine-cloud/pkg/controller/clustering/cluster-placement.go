...
func sortRedisNodeByVM(cluster *submarine.Cluster, nodes submarine.Nodes) map[string]submarine.Nodes {
...
func checkIfSameVM(cluster *submarine.Cluster, redisID, vmName string) bool {
