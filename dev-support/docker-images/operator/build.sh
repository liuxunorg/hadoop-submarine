...
submarine_operator_exists=$(find -L "${SUBMARINE_HOME}/submarine-cloud/target" -name "submarine-operator")
...
cp ${SUBMARINE_HOME}/submarine-cloud/target/submarine-operator "${CURRENT_PATH}/tmp"
